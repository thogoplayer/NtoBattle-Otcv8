...
function CharacterList.create(characters, account, otui)
    ...
    connect(characterList, { onChildFocusChange = function (self, focusedChild) CharacterList.selecting(self,focusedChild) end } )
end

function CharacterList.selecting(self, focusedChild)
    ...
    local vocation_id = tonumber(param[1])
                          charactersWindow:getChildById('slotOutfit'):getChildById('outfit'):setImageSource("../game_health/img/vocations/" .. vocation_id .. ".png")
