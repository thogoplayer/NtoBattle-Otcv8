...
SpellInfo = {
  ['Default'] = {
    ...
    ['Rasengan'] =             {id = 89,  words = 'rasengan',            exhaustion = 2000,  premium = true,  type = 'Instant', icon = 'flamestrike',            mana = 20,     level = 14, soul = 0, group = {[1] = 2000},               vocations = {1, 2, 5, 6}},
